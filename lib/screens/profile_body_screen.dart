    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text('sita.novita@unpak.ac.id', style: vokasiLightGrey),
          Text('081214271544', style: vokasiLightGrey),
          const Spacer(),
          Container(
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('085023006', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Sita Novitasari', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Sita', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Jl. Arzimar III, Rt 03 Rw 03 Tegallega, Kec.Bogor Utara, Kota Bogor Jawa Barat, Indonesia, 16115',
